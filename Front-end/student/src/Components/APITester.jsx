...
const PRESET_ENDPOINTS = [
  { name: 'Root Welcome', method: 'GET', url: `${API_BASE_URL}/` },
  { name: 'Message Dropbox', method: 'GET', url: `${API_BASE_URL}/msg` },
  { name: 'System Info', method: 'GET', url: `${API_BASE_URL}/sys` },
  { name: 'Get All Users', method: 'GET', url: `${API_BASE_URL}/user` },
  { name: 'Get User by ID', method: 'GET', url: `${API_BASE_URL}/user/1` },
  { 
    name: 'Create User', 
    method: 'POST', 
  ...
  { name: 'Delete User', method: 'DELETE', url: `${API_BASE_URL}/user/4` },
  { name: 'Get Registered Data', method: 'GET', url: `${API_BASE_URL}/registered` },
  { 
    name: 'Register User', 
    method: 'POST', 
    url: `${API_BASE_URL}/registered`,
...
export function APITester() {
  ...
  const handleSendRequest = async () => {
    ...
    try {
      ...
      const data = err.response?.data || { error: 'Failed to fetch', details: err.message };
